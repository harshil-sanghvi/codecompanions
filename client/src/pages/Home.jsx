      ...
      <section className="relative p-2 md:px-6 lg:px-24">
        <div className="container flex flex-col-reverse lg:flex-row-reverse items-center gap-12 mt-14 lg:mt-28">
          ...
          <div className="flex flex-1 flex-col items-center lg:items-start">
            <h2 className="text-[#B45309] text-3xl md:text-4xl lg:text-5xl text-center lg:text-left mb-6">
            ...
            <div className="flex justify-center flex-wrap gap-6">
              <a
                ...
                rel="noreferrer"
                target="_blank"
                className="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-[#D97706] hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500"
              >
                Codeforces
              </a>
              <Link
      ...
      <section className="relative bg-slate-50 mt-20 px-2 py-6 md:px-6 md:py-12 lg:py-24 lg:px-24">
        ...
        <div className="relative mt-20 lg:mt-24">
          <div className="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24">
            ...
            {/* Content */}
            <div className="flex flex-1 flex-col items-center lg:items-start">
              <h1 className="text-3xl text-[#B45309] text-center lg:text-left">
        ...
        <div className="relative mt-20">
          <div className="container flex flex-col lg:flex-row-reverse items-center justify-center gap-x-24">
            ...
            {/* Content */}
            <div className="flex flex-1 flex-col items-center lg:items-start">
              <h1 className="text-3xl text-center lg:text-left text-[#B45309]">Engage in a lighthearted competition.</h1>
              <p className="text-gray-600 text-lg my-4 text-center lg:text-left sm:w-3/4 lg:w-full">
